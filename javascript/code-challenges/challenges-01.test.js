...
const addOne = (arr) => {
  let arrNew = [];
  arr.forEach((element)=> arrNew.push(element + 1));
  return arrNew;
};
...
const addExclamation = (arr) => {
  let arrNew = [];
  arr.forEach((element)=> arrNew.push(element + '!'));
  return arrNew;
};
...
const allUpperCase = (arr) => {
  let arrNew = [];
  arr.forEach((element)=> arrNew.push(element.toUpperCase()));
  return arrNew;
};
...
const speaker = (words, callback) => {
  let arrNew = [];
  words.forEach(element => arrNew.push(callback(element)));
  return arrNew;
};
